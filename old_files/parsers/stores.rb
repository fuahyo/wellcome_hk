...
stores.each do |store|
  ...
  keywords.each do |keyword|
    pages << {
      ...
      url: "https://searchgw.dmall.com.hk/app/search/wareSearch",
      method: "POST",
      body: body.gsub("vender_id", vender_id).gsub("store_id", store_id).gsub("replace_keyword", keyword),
      headers: headers,
      vars: {
        vender_id: vender_id,
        store_id: store_id,
